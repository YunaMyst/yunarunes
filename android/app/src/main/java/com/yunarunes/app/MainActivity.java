...
public class MainActivity extends Activity {
    ...
    private static final String APP_CLEANUP =
        ...
        + "nav.style.paddingTop='12px';nav.style.paddingBottom='10px';nav.style.gap='10px';}"
        + "var menu=document.querySelector('.menu-btn');"
        + "if(menu){menu.style.minHeight='44px';menu.style.padding='10px 13px';}"
        + "document.querySelectorAll('.yuna-controls').forEach(function(e){"
        + "e.style.marginTop='4px';e.style.marginBottom='4px';e.style.gap='8px';e.style.minHeight='38px';"
        + "});"
        + "document.querySelectorAll('.yuna-controls a,.yuna-controls button').forEach(function(e){"
        + "e.style.minHeight='38px';e.style.padding='0 11px';}"
        + "}"
        + "clean();"
