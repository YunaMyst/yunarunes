...
public class MainActivity extends Activity {
    ...
    private static final String APP_CLEANUP =
        ...
        + "}"
        + "}"
        + "function fixMobileHeader(){var n=document.querySelector('header.top>.nav'),b=document.querySelector('header.top .brand'),m=document.querySelector('header.top .menu-btn'),l=document.querySelector('header.top .yuna-controls');if(!n||!b||!m||!l)return;n.style.setProperty('display','grid','important');n.style.setProperty('grid-template-columns','auto minmax(0,1fr) auto','important');n.style.setProperty('grid-template-areas','\\\"menu brand controls\\\"','important');n.style.setProperty('align-items','center','important');n.style.setProperty('gap','6px','important');n.style.setProperty('padding','10px 8px','important');n.style.setProperty('min-height','58px','important');b.style.setProperty('grid-area','brand','important');b.style.setProperty('justify-content','center','important');b.style.setProperty('min-width','0','important');b.style.setProperty('margin','0','important');m.style.setProperty('grid-area','menu','important');m.style.setProperty('position','static','important');m.style.setProperty('margin','0','important');m.style.setProperty('white-space','nowrap','important');m.style.setProperty('padding','9px 10px','important');l.style.setProperty('grid-area','controls','important');l.style.setProperty('margin','0','important');l.style.setProperty('justify-content','flex-end','important');l.style.setProperty('gap','3px','important');l.style.setProperty('white-space','nowrap','important');l.querySelectorAll('button').forEach(function(x){x.style.setProperty('height','36px','important');x.style.setProperty('min-width','54px','important');x.style.setProperty('padding','0 5px','important');x.style.setProperty('font-size','10px','important');x.style.setProperty('margin','0','important')});l.querySelectorAll('.apk-link').forEach(function(x){x.style.setProperty('display','none','important')});n.style.setProperty('box-sizing','border-box','important');}"
        + "injectMenuStyle();clean();fixMobileHeader();"
